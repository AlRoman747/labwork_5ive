    ...
    while move == '-1':
        ...
        try:
            ...
            if action == 1:
                ...
                book = Book(author, title, genre, year, genre,f'{random.randint(100, 999)}-{random.randint(0, 9)}-{random.randint(10000, 99999)}-{random.randint(100, 999)}-{random.randint(0, 9)}')
